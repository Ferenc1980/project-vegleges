      ...
      <div class="container-fluid">
          ...
          <?php
            if(isset($_GET['p'])){
              ...
              switch ($program) {
                case 'jelenlet.php':
                  $program=isset($_SESSION['user']) &&
                   preg_match('/\badminisztrator\b/', $_SESSION['user']) ? 'jelenlet.php' : 'jelenlet/jelenletView.php';
                  break;
                case "szabadsag/szabadsag.php":
                  $program=isset($_SESSION['user']) && 
                  preg_match('/\badminisztrator\b/', $_SESSION['user']) ? 'szabadsag/szabadsag.php' : 'szabadsag/szabadsagView.php';
