    ...
    while($row=$stmt->fetch()){
    	...
    	$tbl.="<tr><td>{$azonosito}</td><td>{$nev}</td><td>{$beosztas}</td>";           
             $tbl.="<td class=' btn btn-outline-primary m-1'><a class='text-warning'
			  href='index.php?p=alkalmazottak.php&editId=$azonosito'>Edit</a></td>";
		     $tbl.="<td class=' btn btn-outline-primary  m-1'><a class='text-danger' 
			 href='index.php?p=alkalmazottak.php&deleteId=$azonosito'>Delete</a></td></tr>";
	}
...
<div class="container border">
  ...
  <div class="row ">
	 ...
	 <div class="col-md-4 text-center shadow rounded">
	 	<div class="btn btn-outline-light  m-1 p-1 rounded"><a  href="index.php?p=alkalmazottak.php&insert=alkalmazottak/insert.php"><b>Insert</b> (uj alkalmazott bevezetese)</a></div>
	  </div>
  </div>
